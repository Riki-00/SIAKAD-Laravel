...
<div class="callout callout-info">
  ...
  <div class="panel panel-primary">
      <div class="panel-heading"><center>SEMUA WALI KELAS SMA NEGERI 6 SOLOK SELATAN TELAH DISESUAIKAN</center></div>
          ...
          <div class="md-form"> 
            <div class="box-header">
              ...
              <p><a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-default"><i class="fa fa-plus-circle"></i> Tambah Data</a> <span>
                  <a href="{{url('laporanwalkes')}}" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-print"></i> Print Data</a> </span>  <span> 
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <td>{{$no++}}</td>
                  ...
                  <td><center>
                      <a href="/admin/walkes/tambah_pelajaran/Matapelajaran/{{$tb->id}}" class="btn btn-primary btn-xs"><i class="fa fa-plus-circle"></i> Pelajaran</a> <span>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nama_walas" placeholder="Misal : Prof.Dr.Milda Yenti S.Kom, M.Kom">
                </div>
                <div class="form-group">
                  <label>Kelas</label>
                  <input type="text" class="form-control" name="kelas_walas" placeholder="Misal : X, XI, XII">
                </div>
