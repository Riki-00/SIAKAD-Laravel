        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Milda Yenti &nbsp; <i class="fa fa-angle-down"></i></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Milda Yenti - Web Developer
                  <small>Programmer Masa Depan</small>
                </p>
              </li>
              <!-- Menu Footer-->
              <li class="user-footer">
                <div class="pull-right">
                  <a href="{{url('homeadmin')}}" class="btn btn-default btn-flat"><i class="fa fa-sign-out"></i>&nbsp;Sign out</a>
                </div>
              </li>
            </ul>
          </li>
